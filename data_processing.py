...
RAW_DIR = './raw'
DATA_DIR = './data-obb'         # Directory for CHUNK_SIZE X CHUNK_SIZE images with OBB labels
DATA_YOLO_DIR = './data-cxywh'  # Directory for CHUNK_SIZE X CHUNK_SIZE images with YOLO labels
CHUNK_SIZE = 256
